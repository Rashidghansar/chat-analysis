...
if uploaded_file is not None:
    ...
    # Preprocess the data using the custom preprocessor module
    ...
    # Selectbox to choose the user for analysis
    ...
    if st.sidebar.button("Show Analysis"):
        ...
        #emoji analysis
        # Display the DataFrame and pie chart side by side
        ...
        with col1:
            ...
            with col2:
                if not emoji_df.empty:
                    labels, sizes = emoji_df.iloc[:, 0].head(), emoji_df.iloc[:, 1].head()
